...
__all__ = [
    'DISPID_SPPNumberOfElements', 'DISPID_SRRPhraseInfo',
    'DISPID_SVSpeak', 'SpeechTokenKeyAttributes',
    'DISPID_SABIBufferSize', 'DISPID_SRCEAdaptation', 'IStream',
    'SVPNormal', 'DISPID_SPERetainedStreamOffset',
    'SPRECORESULTTIMES', 'ISpeechVoiceStatus', 'DISPID_SPPsItem',
    'DISPID_SPEs_NewEnum', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SVSInputSentencePosition', 'SVEWordBoundary',
    'SPSSuppressWord', 'SPAS_PAUSE', 'SpShortcut',
    'DISPID_SRIsShared', 'SECFDefault', 'SAFTExtendedAudioFormat',
    'SECHighConfidence', 'DISPID_SREmulateRecognition', 'SPFILEMODE',
    'IInternetSecurityManager', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SVSRunningState', 'SpeechAudioState', 'SPBO_TIME_UNITS',
    'DISPID_SVGetProfiles', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRCEEndStream', 'ISpeechGrammarRule',
    'SSFMCreateForWrite', 'SP_VISEME_5', 'SpeechRunState',
    'SVESentenceBoundary', 'DISPID_SDKEnumValues',
    'DISPID_SVAlertBoundary', 'SAFT24kHz16BitMono', 'SGLexical',
    'SPSEMANTICERRORINFO', 'DISPID_SGRSTPropertyValue',
    ...
    'SRSActiveAlways', 'eLEXTYPE_PRIVATE3', 'DISPID_SLPPartOfSpeech',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SRRAudioFormat',
    'DISPID_SpeechAudioStatus', 'SECFIgnoreCase',
    'DISPID_SRGetPropertyNumber', 'SVEAllEvents',
    'DISPID_SRGCmdLoadFromObject', 'ISpDataKey', 'SPAUDIOOPTIONS',
    'DISPID_SRCVoicePurgeEvent', 'SPEI_RECO_STATE_CHANGE',
    'SVSFPersistXML', 'SPPS_LMA', 'DISPID_SRCPause', 'SVP_14',
    'ISpRecoContext2', 'eLEXTYPE_PRIVATE11', 'SPSFunction',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVSInputSentenceLength',
    'ISpeechCustomStream', 'SpUnCompressedLexicon',
    'DISPID_SDKSetLongValue', 'DISPID_SPPsCount',
    'SpNotifyTranslator', 'SPGRAMMARWORDTYPE',
    ...
    'SAFT16kHz16BitMono', 'DISPID_SGRSAddWordTransition',
    'SRTSMLTimeout', 'SRERecoOtherContext', 'DISPID_SLPLangId',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SPAs_NewEnum', 'SPEI_SR_BOOKMARK', 'eLEXTYPE_PRIVATE17',
    'SPPS_RESERVED1', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SpeechPhraseInfo', 'SVEPrivate', 'SAFTGSM610_44kHzMono',
    'SPRULESTATE', 'eLEXTYPE_PRIVATE6', 'DISPID_SPILanguageId',
    'DISPID_SRSetPropertyNumber', 'SPSModifier', 'ISpeechRecoResult2',
    'DISPID_SLWType', 'SWTAdded', 'DISPID_SpeechAudioBufferInfo',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPADAPTATIONRELEVANCE',
    'SGRSTTRule', 'DISPID_SPPConfidence', 'DISPID_SRGetRecognizers',
    'SPRS_INACTIVE', 'SPDKL_CurrentUser',
    'DISPID_SpeechPhraseElements',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SRRTLength', 'SpInProcRecoContext', 'DISPID_SVSkip',
    'DISPID_SpeechPhraseReplacements', 'SpeechPropertyResponseSpeed',
    'SAFTGSM610_11kHzMono', 'DISPID_SGRSTPropertyName',
    'DISPID_SGRsCommit', 'eLEXTYPE_PRIVATE12', 'ISpeechMMSysAudio',
    'DISPID_SGRs_NewEnum', 'SVSFUnusedFlags',
    'SpeechGrammarTagDictation', 'DISPID_SLWsCount', 'SVSFIsNotXML',
    'SGSEnabled', 'DISPID_SPEAudioStreamOffset', 'SITooFast',
    'SITooLoud', 'DISPID_SVSpeakStream', 'SpeechPropertyAdaptationOn',
    'SVSFParseSsml', 'DISPID_SPIProperties', 'DISPID_SPPId', 'SASRun',
    'SFTSREngine', 'SREPropertyNumChange',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPFM_OPEN_READONLY', 'SVP_16',
    'eLEXTYPE_PRIVATE14', 'DISPID_SRRSpeakAudio',
    'DISPID_SpeechObjectTokens', 'DISPID_SDKGetBinaryValue',
    'ISpeechBaseStream', 'ISpeechPhraseElement',
    'SpeechRetainedAudioOptions', 'SITooQuiet', 'SPAR_Low',
    'SpeechVisemeFeature', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPRuleChildren', 'SVP_15', 'DISPID_SBSRead',
    'DISPID_SGRSRule', 'DISPID_SLPSymbolic',
    'DISPID_SPIAudioStreamPosition', 'SSFMCreate',
    'SPSHORTCUTPAIRLIST', 'SPVPRIORITY', 'SpeechEngineProperties',
    'ISpeechAudioStatus', 'DISPID_SPIRetainedSizeBytes', 'LONG_PTR',
    'DISPID_SVEEnginePrivate', 'DISPIDSPTSI_SelectionLength',
    'SAFT22kHz8BitStereo', 'SAFTADPCM_8kHzStereo',
    'eLEXTYPE_PRIVATE16', 'SREStreamEnd', 'DISPID_SPPs_NewEnum',
    'SpObjectToken', 'DISPID_SpeechXMLRecoResult',
    'SDA_Two_Trailing_Spaces', 'ISpeechPhraseElements', 'SP_VISEME_4',
    'DISPID_SDKGetlongValue', 'eLEXTYPE_RESERVED9', 'SVSFDefault',
    'SVSFParseAutodetect', 'SAFTADPCM_11kHzMono',
    'SVEStartInputStream', 'DISPID_SVIsUISupported', 'SREStateChange',
    'SpeechPartOfSpeech', 'SPWORDPRONUNCIATION', 'SP_VISEME_16',
    'SpeechMicTraining', 'DISPID_SDKGetStringValue', 'ISpNotifySink',
    ...
    'eLEXTYPE_PRIVATE2', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SOTCSetId',
    'DISPID_SLGenerationId', 'eLEXTYPE_PRIVATE1',
    'DISPID_SCSBaseStream', 'SpeechDisplayAttributes',
    'SpeechTokenShellFolder', 'DISPID_SWFEBlockAlign',
    'DISPID_SGRSTNextState', 'DISPID_SpeechRecoResultTimes',
    'SAFT12kHz8BitMono', 'DISPID_SVEViseme', 'SVSFIsXML',
    'SRTStandard', 'DISPID_SPRsCount', 'SpAudioFormat',
    'DISPID_SVEStreamEnd', 'SREPropertyStringChange', 'SPGS_ENABLED',
    'SPGS_DISABLED', 'SPRULE', 'SpeechEmulationCompareFlags',
    'SpeechVoicePriority', 'DISPID_SRCSetAdaptationData',
    'DISPID_SpeechRecoResult2', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPIReplacements',
    'ISpeechRecoResult', 'SPEI_PHRASE_START',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SPIElements',
    'DISPID_SOTsItem', 'ISpeechMemoryStream', 'eLEXTYPE_PRIVATE20',
    'DISPIDSPTSI_ActiveLength', 'SpeechWordPronounceable',
    'DISPID_SLPPhoneIds', 'SP_VISEME_7', 'SDA_One_Trailing_Space',
    'DISPID_SPRuleName', 'SPCT_SUB_COMMAND',
    'DISPID_SASCurrentSeekPosition', 'SpeechAudioFormatGUIDText',
    'DISPID_SRGDictationLoad', 'ISpObjectWithToken',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRSClsidEngine', 'ISpPhrase',
    'DISPID_SASCurrentDevicePosition', 'SpeechVoiceCategoryTTSRate',
    'SpeechRecoProfileProperties', 'DISPID_SPIEnginePrivateData',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpStreamFormatConverter',
    'SPRECOCONTEXTSTATUS', 'SpResourceManager', 'SPLEXICONTYPE',
    'SRAExport', 'SPINTERFERENCE_NOSIGNAL', 'SAFTNoAssignedFormat',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SVGetAudioInputs',
    'SP_VISEME_2', 'IInternetSecurityMgrSite', 'DISPID_SPRText',
    'SPEI_TTS_BOOKMARK', 'SDTAlternates',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'eLEXTYPE_PRIVATE7',
    'DISPIDSPTSI_ActiveOffset', 'STCInprocHandler',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRCRequestedUIType',
    'SP_VISEME_14', 'SP_VISEME_11', 'ISpeechXMLRecoResult',
    'SAFT11kHz8BitStereo', 'ISpeechRecognizerStatus',
    'DISPID_SRRAlternates', 'SAFTDefault', 'SVPOver',
    'DISPID_SABufferNotifySize', 'ISpRecoCategory', 'SVP_2',
    ...
    'ISpeechRecoGrammar', 'SREInterference', 'SPGS_EXCLUSIVE',
    'ISpRecoContext', 'SPAR_Medium',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SPIGetText',
    'DISPID_SMSADeviceId', 'SPWORDPRONUNCIATIONLIST', 'SPWORDLIST',
    'SPBO_PAUSE', 'SAFT48kHz8BitStereo', 'SpStreamFormatConverter',
    'DISPID_SPPName', 'DISPID_SRSSupportedLanguages',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SRCResume',
    'DISPID_SPERequiredConfidence', 'SPDATAKEYLOCATION',
    'SPPHRASEPROPERTY', 'SPWAVEFORMATTYPE', 'SITooSlow',
    'DISPID_SRGCommit', 'SPSMF_SRGS_SAPIPROPERTIES', 'SRTEmulated',
    'SPEI_RESERVED5', 'SP_VISEME_10', 'DISPID_SABufferInfo',
    'ISpVoice', 'DISPID_SRRTTickCount', 'SpMMAudioOut',
    'SPDKL_DefaultLocation', 'DISPID_SFSOpen', 'DISPID_SLPsCount',
    'eLEXTYPE_PRIVATE9', 'SAFTADPCM_22kHzStereo',
    'SpeechSpecialTransitionType', 'DISPID_SGRSTRule',
    'DISPID_SpeechBaseStream', 'DISPID_SMSAMMHandle',
    'SRADefaultToActive', 'DISPID_SVStatus', 'SPEI_RESERVED1',
    'SPAUDIOSTATE', 'DISPID_SRDisplayUI', 'SPEI_END_SR_STREAM',
    'DISPID_SGRsCommitAndSave', 'SPSERIALIZEDPHRASE',
    'SPCONTEXTSTATE', 'SpeechCategoryRecognizers',
    'DISPID_SPEAudioSizeBytes', 'SGDSActiveWithAutoPause',
    'DISPID_SpeechObjectTokenCategory', 'ISpeechPhraseRule',
    'SpeechTokenValueCLSID', 'SpeechUserTraining', 'DISPID_SRCVoice',
    'Speech_StreamPos_Asap', 'DISPID_SAFGuid', 'DISPID_SVSLastResult',
    'ISpRecognizer2', 'SVP_0', 'SLTUser',
    'SpeechCategoryPhoneConverters', 'SPAR_Unknown', 'DISPID_SBSSeek',
    'DISPID_SRGSetTextSelection', 'DISPID_SPEAudioTimeOffset',
    'eLEXTYPE_PRIVATE13', 'SPINTERFERENCE_NONE',
    'SVSFPurgeBeforeSpeak', 'ISpeechRecognizer',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpeechPhraseAlternates',
    'DISPID_SPIGrammarId', 'DISPID_SRGRecoContext', 'SPXRO_SML',
    'SPPS_Interjection', '__MIDL_IWinTypes_0009',
    'SpeechGrammarTagWildcard', 'ISpObjectTokenCategory',
    'SGLexicalNoSpecialChars', 'SVSFNLPMask', 'SpeechRecognitionType',
    'SpInprocRecognizer', 'ISpLexicon', 'SECFNoSpecialChars',
    'SpMemoryStream', 'DISPID_SRCCmdMaxAlternates',
    'SPPS_NotOverriden', 'DISPID_SWFEAvgBytesPerSec',
    'SAFT8kHz16BitMono', 'SSTTWildcard', 'ISpObjectToken',
    'SPPS_Noncontent', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SpeechCustomStream', 'SPPHRASERULE',
    'DISPID_SpeechDataKey', 'DISPID_SPEsItem', 'SRTAutopause',
    'DISPID_SLGetWords', 'DISPID_SPARecoResult', 'SPEI_SR_PRIVATE',
    'SECNormalConfidence', 'SVP_11', 'DISPID_SGRsAdd',
    'DISPID_SpeechMMSysAudio', 'SWPUnknownWordUnpronounceable',
    'SpeechBookmarkOptions', 'ISpeechAudio',
    'DISPID_SVSInputWordPosition', 'SLOStatic', 'SPPS_RESERVED3',
    'DISPID_SWFEExtraData', 'SPEI_SR_AUDIO_LEVEL',
    'ISpeechPhraseProperties', 'DISPID_SOTRemove', 'SGRSTTWord',
    'SPCT_COMMAND', 'DISPID_SRRAudio', 'SPINTERFERENCE',
    'DISPID_SLWPronunciations', 'SVP_6', 'DISPID_SpeechLexiconProns',
    'SRAORetainAudio', 'ISpeechPhraseReplacements', 'SSTTDictation',
    'SPSHT_EMAIL', 'SPSERIALIZEDRESULT', 'DISPID_SRGRules', 'SPSVerb',
    'SPPARTOFSPEECH', 'DISPID_SVDisplayUI', 'SREAdaptation',
    'DISPID_SPRNumberOfElements', 'SVF_Stressed', 'SAFT11kHz8BitMono',
    'SAFT24kHz16BitStereo', 'SpeechCategoryVoices',
    'DISPID_SVAudioOutputStream', 'DISPID_SRSAudioStatus',
    'IEnumString', 'SDTAll', 'SAFT8kHz16BitStereo', 'SRSEDone',
    'DISPID_SRGCmdSetRuleState', 'SPVISEMES', 'SpStream',
    'SWTDeleted', 'SDTReplacement', 'DISPID_SLPsItem', 'SVF_Emphasis',
    'DISPID_SRSetPropertyString', 'DISPID_SpeechRecoContext',
    'DISPID_SRCERequestUI', 'SPEI_SOUND_START', 'SP_VISEME_6',
    'DISPID_SWFESamplesPerSec', 'DISPID_SLGetGenerationChange',
    'eLEXTYPE_USER_SHORTCUT', 'SWPUnknownWordPronounceable',
    'SpCompressedLexicon', 'SVP_10', 'SpeechCategoryAudioOut',
    'SVEEndInputStream', 'ISpEventSource', 'DISPID_SGRsCount',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SVEAudioLevel', 'SDTPronunciation',
    'SpeechAudioFormatType', 'SPCS_DISABLED', 'SPDKL_CurrentConfig',
    'SAFTGSM610_8kHzMono', 'DISPID_SpeechPhraseBuilder',
    'SAFTGSM610_22kHzMono', 'SPPHRASE',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPAPhraseInfo',
    'DISPID_SDKDeleteValue', 'SP_VISEME_8', 'SpPhoneConverter',
    'SASPause', 'WAVEFORMATEX', 'SpeechGrammarTagUnlimitedDictation',
    'SGRSTTTextBuffer', 'ISpeechRecoResultDispatch',
    'DISPID_SVSLastBookmarkId', 'IEnumSpObjectTokens',
    'DISPID_SGRsDynamic', 'SDTDisplayText',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRGCmdLoadFromResource', 'SPBOOKMARKOPTIONS',
    'DISPID_SpeechRecognizer', 'STCLocalServer', 'DISPID_SVPause',
    'DISPIDSPRG', 'SpeechRuleAttributes', 'DISPID_SPPValue',
    'eLEXTYPE_USER', 'SSFMOpenReadWrite', 'SPEI_PHONEME',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SRGetPropertyString',
    'DISPID_SDKEnumKeys', 'ISpXMLRecoResult',
    'DISPID_SRGDictationUnload', 'SPWT_PRONUNCIATION',
    'DISPID_SPPEngineConfidence', 'SPAUDIOSTATUS',
    'SAFT16kHz8BitMono', 'SRAONone', 'ISpeechObjectToken',
    'ISpNotifySource', 'DISPID_SVSInputWordLength',
    ...
    'DISPID_SpeechGrammarRuleStateTransition', 'SPEVENTSOURCEINFO',
    'SAFT8kHz8BitStereo', 'SPWORDTYPE', 'SpeechRecognizerState',
    'DISPID_SOTCDefault', 'eLEXTYPE_PRIVATE15',
    'SpNullPhoneConverter', 'SPEI_MIN_TTS', 'SPEI_UNDEFINED',
    'SPRECOGNIZERSTATUS', 'SRSEIsSpeaking', 'ISpRecognizer3',
    'DISPID_SFSClose', 'SAFT11kHz16BitStereo', 'DISPID_SRGId',
    'DISPID_SGRsItem', 'DISPID_SGRId', 'SAFTCCITT_uLaw_44kHzStereo',
    'SpVoice', 'STCRemoteServer', 'SpeechGrammarWordType', 'STCAll',
    'DISPID_SLRemovePronunciation', 'SpeechRegistryUserRoot',
    'ISpRecoGrammar2', 'DISPID_SpeechGrammarRules',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPVPRI_NORMAL',
    'DISPID_SRRTOffsetFromStart', 'ISpeechTextSelectionInformation',
    'DISPID_SVEBookmark', 'DISPID_SGRAddResource', 'SPSHT_Unknown',
    'eLEXTYPE_RESERVED4', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SP_VISEME_12', 'SpeechTokenKeyUI',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechInterference',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRCCreateResultFromMemory',
    'ISpeechPhoneConverter', 'SPEI_END_INPUT_STREAM',
    'eLEXTYPE_RESERVED10', 'SPVPRI_ALERT',
    '_ISpeechRecoContextEvents', 'SPPS_Modifier', 'SRARoot',
    'SPSUnknown', 'DISPID_SPRulesCount', 'tagSPPROPERTYINFO',
    'ISpPhoneConverter', 'DISPID_SAVolume', 'SPEI_ADAPTATION',
    'SVPAlert', 'SPEI_RESERVED3', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SOTDataKey', 'DISPID_SPIEngineId',
    'DISPID_SVEStreamStart', 'SPSMF_UPS', 'SPEI_WORD_BOUNDARY',
    'DISPID_SPRuleNumberOfElements', 'SPAUDIOBUFFERINFO', 'SBOPause',
    'SREHypothesis', 'eLEXTYPE_RESERVED8', 'ISpeechPhraseAlternate',
    'SP_VISEME_19', 'DISPID_SRCERecognitionForOtherContext',
    'eLEXTYPE_PRIVATE4', 'ISpeechGrammarRuleState',
    'DISPID_SOTGetAttribute', 'SPWORDPRONOUNCEABLE',
    'DISPID_SpeechVoiceEvent', 'DISPID_SpeechLexicon', 'SPWT_DISPLAY',
    'ISpeechRecoResultTimes', 'DISPID_SGRAttributes',
    'DISPID_SVVoice', 'SAFTCCITT_uLaw_22kHzStereo', 'ISpAudio',
    '_ISpeechVoiceEvents', 'DISPID_SPIRule', 'SAFTText',
    'DISPID_SVGetAudioOutputs', 'DISPID_SVEWord',
    'DISPID_SRIsUISupported', 'DISPID_SGRSTText',
    'DISPID_SGRSTWeight', 'ISpeechRecoContext', 'ISpeechObjectTokens',
    'SPVOICESTATUS', 'SPEI_START_SR_STREAM', 'DISPID_SpeechAudio',
    'SSSPTRelativeToEnd', 'SPEI_RESERVED6', 'DISPID_SPCLangId',
    'UINT_PTR', 'DISPID_SVSyncronousSpeakTimeout',
    'SpeechRecoContextState', 'SPCT_DICTATION', 'DISPID_SBSFormat',
    'SDA_No_Trailing_Space', 'DISPID_SDKCreateKey',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPBO_AHEAD',
    'DISPID_SOTSetId', 'ISpPhraseAlt', 'DISPID_SRCEEnginePrivate',
    'SPRST_ACTIVE', 'DISPID_SPEsCount', 'SAFT44kHz16BitMono',
    'DISPID_SRRTimes', 'DISPID_SRCreateRecoContext', 'SPLO_DYNAMIC',
    'SBONone', 'SpeechStreamFileMode', 'SpCustomStream', 'SREPrivate',
    'SVEViseme', 'SPAO_NONE', 'DISPID_SRProfile',
    'DISPID_SpeechMemoryStream', 'SVSFParseMask', 'SPRST_INACTIVE',
    'DISPID_SPISaveToMemory', 'DISPID_SBSWrite',
    'SAFT32kHz8BitStereo', 'DISPID_SRAudioInputStream',
    'SECFEmulateResult', 'DISPID_SRCEAudioLevel',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPIAudioSizeBytes', 'SRSInactive',
    'DISPID_SGRName', 'DISPID_SPRs_NewEnum', 'DISPID_SWFEChannels',
    'DISPIDSPTSI_SelectionOffset', 'SP_VISEME_18',
    'ISpeechLexiconPronunciation', 'ISpeechAudioBufferInfo',
    'DISPID_SRCRecognizer', 'SREBookmark', 'DISPID_SVEPhoneme',
    'SPEI_HYPOTHESIS', 'ISpRecognizer', 'DISPID_SpeechPhoneConverter',
    'DISPID_SRCEStartStream', 'SPINTERFERENCE_NOISE',
    'SpeechVoiceEvents', 'SRSActive', 'SVEBookmark', 'ISpStream',
    'DISPID_SPAsCount', 'DISPID_SRGDictationSetState',
    'DISPID_SWFEBitsPerSample', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SADefaultFormat', 'STCInprocServer',
    'SAFT44kHz16BitStereo', 'SSSPTRelativeToStart',
    'DISPID_SPRuleEngineConfidence', 'SPEVENTENUM',
    'SpPhoneticAlphabetConverter',
    'ISpeechGrammarRuleStateTransition', 'SREPhraseStart',
    'ISpRecoGrammar', 'SRAInterpreter', 'DISPID_SPACommit',
    'eLEXTYPE_PRIVATE5', 'DISPID_SGRClear', 'SINoise',
    'SpeechWordType', 'DISPID_SLPType', 'DISPID_SPRuleParent',
    'SPXMLRESULTOPTIONS', 'SAFT48kHz16BitStereo', 'DISPID_SVVolume',
    'SVP_13', 'SPAS_RUN', 'ISpeechAudioFormat', 'SDTLexicalForm',
    'SPAR_High', 'DISPID_SGRSTsCount', 'STSF_AppData',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPCPhoneToId',
    'DISPID_SMSGetData', 'ISpeechLexiconPronunciations',
    'DISPID_SRSNumberOfActiveRules', 'SVP_4', 'SPSHT_OTHER',
    'DISPID_SpeechVoiceStatus', 'SECFIgnoreKanaType',
    'SPSEMANTICFORMAT', 'SPCATEGORYTYPE', 'SPLO_STATIC',
    'Speech_Max_Pron_Length', 'SAFT32kHz16BitStereo', 'SDTRule',
    'DISPID_SLWWord', 'ISpeechDataKey', 'SPPS_SuppressWord',
    'DISPID_SRGetFormat', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPEI_SR_RETAINEDAUDIO', 'ISpeechLexiconWords',
    'eLEXTYPE_PRIVATE19', 'ISpeechResourceLoader',
    'DISPID_SGRSTransitions', 'SAFTCCITT_ALaw_22kHzStereo',
    'SASClosed', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SVSPhonemeId', 'ISpeechPhraseRules',
    'DISPID_SRRRecoContext', 'DISPID_SOTs_NewEnum',
    'DISPID_SpeechGrammarRuleState', 'SpWaveFormatEx',
    'SpeechVisemeType', 'DISPID_SRCERecognition', 'SRERecognition',
    'SLODynamic', 'DISPID_SpeechRecognizerStatus',
    'Speech_StreamPos_RealTime', 'ISpeechPhraseInfo', 'SINoSignal',
    'DISPID_SPIGetDisplayAttributes', 'SGRSTTEpsilon', 'SVP_18',
    'ISpeechGrammarRules', 'DISPID_SPRFirstElement', 'SpLexicon',
    'SPEI_SOUND_END', 'ISpSerializeState',
    'DISPID_SRGIsPronounceable', 'DISPID_SOTGetStorageFileName',
    'ISpeechWaveFormatEx', 'SRAImport', 'eLEXTYPE_APP', 'SVP_12',
    'SSSPTRelativeToCurrentPosition', 'SpSharedRecoContext',
    'DISPID_SAEventHandle', 'DISPID_SABIEventBias', 'SGDisplay',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SpeechRecoContextEvents',
    'SPEI_RECO_OTHER_CONTEXT', 'SP_VISEME_0', 'SGRSTTDictation',
    'SGRSTTWildcard', 'SpTextSelectionInformation', 'SRESoundEnd',
    'DISPID_SVRate', 'SpeechDictationTopicSpelling', 'SP_VISEME_17',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SASetState',
    'DISPID_SMSALineId', 'SpeechDataKeyLocation',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_START_INPUT_STREAM', 'DISPID_SDKSetBinaryValue',
    'DISPID_SPRsItem', 'eLEXTYPE_RESERVED6', 'SPTEXTSELECTIONINFO',
    'DISPID_SRCEventInterests', 'DISPID_SRGState', 'SPPS_RESERVED4',
    'DISPID_SRRSetTextFeedback', 'SPEI_MIN_SR',
    'DISPID_SRSCurrentStreamNumber', 'SVSFVoiceMask',
    'DISPID_SOTCategory', 'SPSHT_NotOverriden', 'SGDSInactive',
    'SpeechAudioProperties', 'SpMMAudioIn', 'SPRS_ACTIVE',
    'SPPS_Unknown', 'DISPID_SRCEInterference', 'DISPID_SLWLangId',
    'SAFT16kHz8BitStereo', 'ISpShortcut', 'DISPID_SPIStartTime',
    'SVP_17', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechRuleState', 'SPEI_MAX_SR', 'DISPID_SLWs_NewEnum',
    ...
    'DISPID_SPEDisplayText', 'DISPID_SPCIdToPhone', 'SPSInterjection',
    'DISPID_SDKDeleteKey', 'SAFT11kHz16BitMono', 'SDTProperty',
    'STSF_CommonAppData', 'SPEI_INTERFERENCE',
    'ISpPhoneticAlphabetSelection', 'SPEI_VOICE_CHANGE',
    'SPINTERFERENCE_TOOFAST', 'SWPKnownWordPronounceable',
    'SPCT_SLEEP', 'SPRECOSTATE', 'ISpMMSysAudio',
    'DISPID_SGRInitialState', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRCEHypothesis', 'DISPID_SpeechLexiconWords', 'SVP_9',
    ...
    'SVEAudioLevel', 'ISequentialStream',
    'DISPID_SRCEPropertyStringChange', 'SPEI_TTS_PRIVATE',
    'SDKLCurrentUser', 'DISPID_SPEActualConfidence', 'SPWORD',
    'SP_VISEME_1', 'SDKLDefaultLocation',
    'DISPID_SRCEPropertyNumberChange', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SMSSetData', 'SSTTTextBuffer', 'DISPID_SPRuleConfidence',
    'SREFalseRecognition', 'SP_VISEME_9', 'DISPID_SpeechVoice',
    'ISpRecoResult', 'SREAllEvents', 'DISPID_SPRules_NewEnum',
    'SpeechDiscardType', 'Speech_Max_Word_Length',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPEI_RESERVED2', 'SPSHORTCUTTYPE',
    'SAFT12kHz16BitStereo', 'DISPID_SOTDisplayUI', 'SPPHRASEELEMENT',
    'ISpeechObjectTokenCategory', 'SP_VISEME_3',
    'DISPID_SVEVoiceChange', 'SPAS_CLOSED', 'DISPID_SPPChildren',
    'SVP_8', 'DISPID_SRCState', 'tagSTATSTG', 'DISPID_SVSVisemeId',
    'SPWF_INPUT', 'SpFileStream', 'DISPID_SVWaitUntilDone',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SGRSTsItem',
    'SPEI_VISEME', 'ISpeechLexiconWord', 'SPFM_NUM_MODES',
    'SGDSActiveUserDelimited', 'DISPID_SPPParent', 'SPEI_RECOGNITION',
    'SGDSActive', 'SPSHORTCUTPAIR', 'STSF_FlagCreate', 'SFTInput',
    'DISPID_SpeechPhraseRules', 'SAFTADPCM_11kHzStereo',
    'SAFTADPCM_8kHzMono', 'DISPID_SGRAddState',
    'DISPID_SASNonBlockingIO', 'SPRST_NUM_STATES',
    'SPSMF_SAPI_PROPERTIES', 'SRCS_Enabled', 'SVSFIsFilename',
    'SAFT16kHz16BitStereo', 'SPDKL_LocalMachine', 'SECFIgnoreWidth',
    'SpeechRecoEvents', 'SPSLMA', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRCEFalseRecognition', 'DISPID_SpeechObjectToken',
    'DISPID_SOTCId', 'DISPID_SRGReset', 'DISPID_SVResume', 'SVP_21',
    'DISPID_SRCEBookmark', 'DISPID_SRRecognizer', 'DISPID_SOTsCount',
    'eLEXTYPE_PRIVATE18', 'SPWF_SRENGINE',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SGRSAddRuleTransition',
    'SPLOADOPTIONS', 'ISpeechLexicon', 'SPINTERFERENCE_TOOLOUD',
    'SVP_20', 'ISpeechVoice', 'SVSFlagsAsync', 'SPPS_Noun',
    'DISPID_SLPs_NewEnum', 'SpeechCategoryAudioIn',
    'DISPID_SRRGetXMLResult', 'SRSInactiveWithPurge',
    'DISPID_SVPriority', 'SVF_None', 'SpMMAudioEnum', 'SP_VISEME_21',
    'DISPID_SAFType', 'DISPID_SVAudioOutput',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechPropertyHighConfidenceThreshold', 'SpeechAddRemoveWord',
    'DISPID_SRCESoundStart', 'STSF_LocalAppData', 'eWORDTYPE_DELETED',
    ...
    'DISPID_SASState', 'DISPID_SVSLastBookmark',
    'DISPID_SAFSetWaveFormatEx', 'SAFT44kHz8BitMono',
    'SPINTERFERENCE_TOOSLOW', 'eLEXTYPE_RESERVED7',
    'SpeechLexiconType', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SAStatus', 'DISPID_SOTMatchesAttributes', 'SPPS_Function',
    'SPFM_CREATE', 'SVP_5', 'SGSDisabled', 'SVEVoiceChange',
    'SRCS_Disabled', 'DISPID_SPRuleFirstElement',
    'DISPID_SABIMinNotification', 'SAFT8kHz8BitMono',
    'SpeechVoiceSpeakFlags', 'SPAO_RETAIN_AUDIO', 'SPSNoun',
    'SPBO_NONE', 'DISPID_SDKOpenKey', 'SSFMOpenForRead',
    'SRESoundStart', 'SLTApp', 'SREAudioLevel', 'DISPID_SGRsFindRule',
    'SPPROPERTYINFO', 'SPXRO_Alternates_SML', 'SpeechFormatType',
    'SVSFNLPSpeakPunc', 'SAFTCCITT_ALaw_11kHzMono', 'SVP_19',
    'SRTReSent', 'DISPID_SRStatus', 'SPVPRI_OVER',
    'SAFTADPCM_44kHzMono', 'SDKLCurrentConfig',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SpeechPhraseRule',
    'ISpProperties', 'ISpNotifyTranslator',
    ...
    'SVEPhoneme', 'SAFT22kHz8BitMono', 'DISPID_SpeechRecoResult',
    'SpeechAudioVolume', 'SVP_1', 'eLEXTYPE_MORPHOLOGY', 'SASStop',
    'DISPID_SRRTStreamTime', 'SP_VISEME_20', 'SpeechAllElements',
    'DISPID_SRGCmdLoadFromFile', 'SVSFParseSapi',
    ...
    'SPPS_RESERVED2', 'DISPID_SPRuleId', 'SPEI_MAX_TTS',
    'SPPHRASEREPLACEMENT', 'DISPID_SRState', 'DISPID_SRCESoundEnd',
    'SAFT32kHz16BitMono', 'DISPID_SRRGetXMLErrorInfo', 'SRATopLevel',
    'SAFT12kHz16BitMono', 'SAFT32kHz8BitMono', 'SINone',
    'SAFTNonStandardFormat', 'ISpResourceManager',
    'DISPID_SLAddPronunciation', 'DISPID_SGRSTPropertyId',
    'DISPID_SRRDiscardResultInfo', 'SAFTCCITT_ALaw_44kHzMono',
    'SpeechCategoryRecoProfiles', 'SpeechStreamSeekPositionType',
    'SRADynamic', 'DISPID_SPEPronunciation', 'SAFTADPCM_22kHzMono',
    'DISPID_SWFEFormatTag', 'DISPID_SRGCmdSetRuleIdState', 'SVP_7',
    'DISPIDSPTSI', 'ISpeechFileStream', 'DISPID_SDKSetStringValue',
    'ISpEventSink', 'SPEVENT', 'SAFT24kHz8BitMono',
    'DISPID_SPPFirstElement', 'SPFM_OPEN_READWRITE', 'SP_VISEME_13',
    'DISPID_SpeechLexiconWord', 'SPBINARYGRAMMAR',
    'SAFT12kHz8BitStereo', 'SAFT48kHz16BitMono',
    'DISPID_SRCCreateGrammar', 'ISpeechPhraseProperty',
    'SPFM_CREATE_ALWAYS', 'eWORDTYPE_ADDED', 'SpPhraseInfoBuilder',
    'ISpeechPhraseReplacement', 'SAFT22kHz16BitStereo', 'SDTAudio',
    'SECLowConfidence', 'SPCS_ENABLED', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SVGetVoices', 'DISPID_SOTIsUISupported',
    'DISPID_SPAsItem', 'SAFT22kHz16BitMono', '_SPAUDIOSTATE',
    'SRTExtendableParse', 'DISPID_SRSCurrentStreamPosition',
    'SPPS_Verb', 'SPAS_STOP', 'SGSExclusive', 'SPGRAMMARSTATE',
    'DISPID_SVEventInterests', 'SPSNotOverriden', 'SREStreamStart',
    'SP_VISEME_15', 'DISPID_SpeechAudioFormat', 'DISPID_SLWsItem',
    'DISPID_SRCBookmark', 'SPCT_SUB_DICTATION',
    'SpeechAudioFormatGUIDWave', 'DISPID_SOTId', 'DISPID_SGRSTType'
]

_check_version('1.1.14', 1652393697.045008)
